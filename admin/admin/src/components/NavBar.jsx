...
const NavBar = () => {    
  ...
  return (
    <div className='flex justify-between items-center bg-white border-b px-4'>
        <div onClick={()=> navigate('/')} className='flex items-center text-xs'>
        ...
        <button onClick={logout} className='bg-blue-500 text-white text-base cursor-pointer rounded-full p-1.5 px-4'>Logout</button>
    </div>
  )
}
