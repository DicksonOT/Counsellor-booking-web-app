        ...
        <div className="p-6 bg-white rounded-lg shadow-lg">
                ...
                {loading && activities.length === 0 ? (
                    ...
                    <>
                        ...
                        {activities.map((activity) => {
                            ...
                            return (
                                <div key={activity._id} className="border rounded-lg p-5 hover:shadow-md transition-shadow">
            ...
            {activities.length > 0 && (
                <div className="mt-6 flex flex-wrap gap-3">
                    ...
                    <button
                        ...
                        className="bg-yellow-100 text-yellow-800 px-4 py-2 rounded-lg hover:bg-yellow-200 transition text-sm"
                    >
                        ⏰ Check Expiring
                    </button>
                </div>
            ...
            {process.env.NODE_ENV === 'development' && (
                <div className="mt-6 p-3 bg-gray-100 rounded text-xs text-gray-600">
                    ...
                    Use template: {useTemplate.toString()}
                </div>
            )}
        </div>
    );
