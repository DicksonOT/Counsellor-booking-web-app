                ...
                <div>
                  ...
                  <div className="flex items-center mt-2 space-x-4">
                    ...
                    <span className="text-sm text-gray-500">
                      Member since {formattedDateUniversal(userData.createdAt)}
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-900 font-medium">
                          {userData.dob ? formattedDateUniversal(userData.dob) : "N/A"}
                        </p>
                      </div>
                    </div>
                  </div>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-4 mb-2">
                              <span className="text-lg font-medium text-gray-900">
                                {formattedDateUniversal(appointment.slotDate)}
                              </span>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="text-gray-600 text-sm space-y-1">
                              {session.scheduledTime && (
                                <p>Scheduled: {formattedDateUniversal(session.scheduledTime)}</p>
                              )}
                              <p>Duration: {session.duration} minutes</p>
                              {session.startTime && (
                                <p>Started: {formattedDateUniversal(session.startTime)}</p>
                              )}
                              {session.endTime && (
                                <p>Ended: {formattedDateUniversal(session.endTime)}</p>
                              )}
                              {session.notes && (
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">{formattedDateUniversal(appointmentData.slotDate)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                ...
                {userSessions.length > 0 && (
                  <div className="text-sm">
                    ...
                    <p className="font-medium text-gray-900">
                      {formattedDateUniversal(userSessions[0].scheduledTime || userSessions[0].createdAt)}
                    </p>
                  </div>
                )}
                {userAppointments.length > 0 && (
                  <div className="text-sm">
                    ...
                    <p className="font-medium text-gray-900">
                      {formattedDateUniversal(userAppointments[0].slotDate)}
                    </p>
                  </div>
                )}
                {userData.createdAt && (
                  <div className="text-sm">
                    ...
                    <p className="font-medium text-gray-900">
                      {formattedDateUniversal(userData.createdAt)}
                    </p>
                  </div>
                )}
              </div>
