            ...
            <div className='hidden lg:flex items-center gap-10'>
                <ul className='flex items-center gap-8 font-medium'>
                    <NavLink to='/' onClick={() => window.scrollTo(0,0)} className={({ isActive }) => 
                        `relative py-3 px-4 transition-colors duration-200 hover:text-blue-600 ${
                    ...
                    {navigationItems.map((navItem, index) => (
                        ...
                        >
                            ...
                            <div className={`absolute top-full left-0 mt-3 w-96 bg-white border border-gray-200 shadow-2xl rounded-xl overflow-hidden transition-all duration-200 ${
            ...
            <div className={`${
                ...
                <div className='flex flex-col px-6 py-4'>
                    <NavLink 
                        ...
                        to='/'
                        className={({ isActive }) => 
                            `px-4 py-3 rounded-lg text-base font-medium mb-3 transition-colors duration-200 ${
